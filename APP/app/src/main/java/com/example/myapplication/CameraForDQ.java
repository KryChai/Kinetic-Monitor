...
public class CameraForDQ extends AppCompatActivity {
...
//                开新界面
                Intent intent=new Intent(CameraForDQ.this, Waiting_DQ.class);
...
//            imageDimension = map.getOutputSizes(SurfaceTexture.class)[0];
        ...
        try {
            ...
            cameraDevice.createCaptureSession(Collections.singletonList(surface), new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                    Toast.makeText(CameraForDQ.this, "配置失败", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        mediaRecorder.setOutputFile(new File(getExternalFilesDir(""),"dq.mp4").getAbsolutePath());
